...
export default function ListingDetailPage() {
  ...
  return (
    <div className="max-w-5xl mx-auto px-3 sm:px-4 py-5 sm:py-8">
      ...
      {/* Content grid — 1 col on mobile, 3 col (2+1) on lg */}
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-4 sm:gap-6">
        ...
        {/* Sidebar — on mobile shows after main content, on lg sticks to the side */}
        <div className="space-y-4">
          <div className="card lg:sticky lg:top-20">
            ...
            {!isOwner && (
              <button onClick={handleContact} className="btn-primary w-full flex items-center justify-center gap-2 text-sm">
